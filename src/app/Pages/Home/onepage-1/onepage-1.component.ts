...
@Component({
    selector: 'app-onepage-1',
    imports: [CommonModule, RouterLink, BtnMainHoverDirective],
    templateUrl: './onepage-1.component.html',
    styleUrl: './onepage-1.component.css'
})
export class Onepage1Component {
  ...
  stars = [1, 2, 3, 4, 5];
  features = [
    { img: 'assets/images/icons/1.png', title: 'Super Quick Setup', description: 'Dolor minim in pariatur in deserunt laboris eu pariatur labore excepteur cupidatat cupidatat duis dolor in.', delay: 0 },
    { img: 'assets/images/icons/2.png', title: 'Premium Hardware', description: 'Dolor minim in pariatur in deserunt laboris eu pariatur labore excepteur cupidatat cupidatat duis dolor in.', delay: 200 },
    { img: 'assets/images/icons/3.png', title: 'DDos Protection', description: 'Dolor minim in pariatur in deserunt laboris eu pariatur labore excepteur cupidatat cupidatat duis dolor in.', delay: 400 },
    { img: 'assets/images/icons/4.png', title: 'Fast Support', description: 'Dolor minim in pariatur in deserunt laboris eu pariatur labore excepteur cupidatat cupidatat duis dolor in.', delay: 600 },
  ];
  galleryItems = [
    {
  ...
  hotspots = [
    { label: 'United States', top: '39%', left: '20%', delay: 0 },
    { label: 'Australia', top: '76%', left: '87%', delay: 200 },
    { label: 'Indonesia', top: '68%', left: '80%', delay: 300 },
    { label: 'Canada', top: '23%', left: '18%', delay: 400 },
    { label: 'Brazil', top: '68%', left: '33%', delay: 500 },
    { label: 'China', top: '45%', left: '75%', delay: 600 },
    { label: 'France', top: '36%', left: '48%', delay: 200 },
    { label: 'Sweden', top: '23%', left: '51%', delay: 700 },
    { label: 'South Africa', top: '78%', left: '53%', delay: 800 }
  ];
  cities = [
  ...
  payments = [
    { image: 'assets/images/payments/visa.webp', alt: 'Visa' },
    { image: 'assets/images/payments/mastercard.webp', alt: 'Mastercard' },
    { image: 'assets/images/payments/paypal.webp', alt: 'PayPal' },
    { image: 'assets/images/payments/skrill.webp', alt: 'Skrill' },
    { image: 'assets/images/payments/jcb.webp', alt: 'JCB' },
    { image: 'assets/images/payments/american-express.webp', alt: 'American Express' }
  ];
